...
$string['settings:displayurlparams'] = 'Display URL params';
$string['settings:displayurlparams_desc'] = 'Whether or not to display report URL parameters';
...
$string['successfulchange'] = 'Changes saved successfully.';
$string['vieweditlog'] = 'View Edit History';
$string['destree'] = 'Decision Tree';
